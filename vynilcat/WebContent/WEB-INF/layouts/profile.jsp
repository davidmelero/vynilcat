...
<section id="userInfo">
	...
	<a href='<c:url value="/profile/${user.userName}/contact"/>' class="orange">
		<img id='mail' class="icon" src='<c:url value="/images/icons/mail.png" />' />
		<b>Contacto con el administrador</b>
	</a>
	<br/>
